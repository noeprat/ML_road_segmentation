...
class TransformerBlock(tf.keras.layers.Layer):
    def __init__(self, embed_dim, num_heads, ff_dim, rate=0.1):
        ...
        self.layernorm1 = BatchNormalization(epsilon=1e-6)
        self.layernorm2 = BatchNormalization(epsilon=1e-6)
...
def vit_small(input_size=(304, 304, 1)):
    ...
    for i in range(NB_BLOCKS):
        ...
        c = TransformerBlock(16, 3, 16)(c)

    outputs = Conv2D(1, (1, 1),activation='sigmoid')(c)
    
    
    model = Model(inputs, outputs, name="ViT_early_conv")
    return model
...
def load_model_and_data():
    ...
    # Create the model    
    model3 = vit_small(input_size=(304, 304, 3))
